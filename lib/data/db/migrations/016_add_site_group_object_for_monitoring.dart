...
Future<void> migration16(Migrator m, GeneratedDatabase db) async {
  ...
  try {
    // Insert into `cor_object_module` table
    ...
    //   );
    // ''');
    print("Inserted MONITORINGS_GRP_SITES into cor_object_module");
  } catch (e) {
...
Future<void> downgrade16(Migrator m, GeneratedDatabase db) async {
  ...
  try {
    ...
    ''');
    print("Removed MONITORINGS_GRP_SITES from cor_object_module");
  } catch (e) {
